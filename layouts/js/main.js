...
visaCard.addEventListener("click", function (e) {
  ...
  cardTypeBottom.setAttribute("src", "./images/logos_visaelectron.svg");
  // src="./images/logos_visaelectron.svg"
});

paypalCard.addEventListener("click", function (e) {
  document.body.style.backgroundColor = "lightblue";
  backText.innerHTML = "PayPal";
  cardTypeBottom.setAttribute("src", "./images/PayPal2007.svg.png");
});

masterCard.addEventListener("click", function (e) {
  document.body.style.backgroundColor = "orange";
  backText.innerHTML = "Mastercard";
  cardTypeBottom.setAttribute("src", "./images/grommet-icons_mastercard.svg");
});
